...
import { unlockAchievement, getUserAchievements, getAllAchievements } from '../db/db_achievements.js';
...
export async function numberRoutes(app: FastifyInstance) {
	...
	app.post("/number", { preValidation: [app.authenticate] }, async (req: any, reply: any) => {
