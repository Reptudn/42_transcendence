...
export const dataBaseLocation = path.resolve(__dirname, '../../../db/transcendence.db');

// import achievementsData from '../../../data/achievements.json';
// import { FastifyInstance } from 'fastify';

// async function createDatabase(fastify: FastifyInstance) {
...
// 	fastify.log.info('Database location:', dataBaseLocation);
